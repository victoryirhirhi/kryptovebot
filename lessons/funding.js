...
export const fundingQuiz = {
  questions: [
    { q: "What is one way to get funding in Web3?", options: ["Mining Bitcoin", "DAO Grants", "Buying NFTs only", "Trading Futures"], answer: 1 },
    { q: "What should a funding proposal include?", options: ["A clear goal and impact", "Random numbers", "Just your name", "Nothing"], answer: 0 }
  ],
  passingScore: 70
};
